<section class="wthree-row w3-about">
    <div class="container py-4 mt-2">
        ...
        <div class="card-deck pt-4 mt-md-4" id="different_way_to">
            <div class="card">
                ...
                <div class="card-body w3ls-card">
                    ...
                    <a class="blog-btn more-info" data-toggle="collapse" href="#" target="ticketsForm">Solicitar Orçamento</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body w3ls-card">
                    ...
                    <a class="blog-btn more-info" data-toggle="collapse" href="#" target="hotelsForm">Solicitar Orçamento</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body w3ls-card">
                    ...
                    <!--                        <a href="#" class="blog-btn more-info" data-toggle="modal" data-target="#myModal">Solicitar Orçamento</a>-->
                    <a class="blog-btn more-info" data-toggle="collapse" href="#" target="cruiseForm">Solicitar Orçamento</a>
                </div>
            </div>
        </div>
    </div>
