...
switch (ENVIRONMENT)
{
	case 'development':
		$db['default'] = array(
            'dsn'	=> '',
            // 'hostname' => 'localhost',
            'hostname' => getenv('LETSFLYDB_ADDRESS',  	true) ? : getenv('LETSFLYDB_ADDRESS'),
            'username' => getenv('LETSFLYDB_USER', 		true) ? : getenv('LETSFLYDB_USER'),
            'password' => getenv('LETSFLYDB_PASSWORD', 	true) ? : getenv('LETSFLYDB_PASSWORD'),
            'database' => 'letsfly',
            'dbdriver' => 'mysqli',
            'dbprefix' => '',
            'pconnect' => false,
